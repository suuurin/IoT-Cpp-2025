...
private:
	int m_value;
	const int m_value2;			// 상수 취급: 선언과 동시에 초기화 함께
								// 상쉬 멤버 변수는 객체 생성되기 전에 반드시 초기화가 되어야 한다. --> 무조건~!!! 콜론 초기화
public:
	ConstClass(int value, int value2) : m_value2(value2), m_value(value) {}	//{ m_value = value;}
	void showValue() {
